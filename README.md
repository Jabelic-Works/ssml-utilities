...
- [@ssml-utilities/accent-ir](#ssml-utilitiesaccent-ir)
...
// AccentIR を入力し、各 provider 向け SSML を生成
```
...
- [@ssml-utilities/accent-ir API](https://github.com/Jabelic-Works/ssml-utilities/tree/master/packages/accent-ir)
